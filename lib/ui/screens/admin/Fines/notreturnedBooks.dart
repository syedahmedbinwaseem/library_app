                                                                ...
                                                                child:
                                                                    ClipRRect(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            payFine(snapshot.data.docs[index]);
                                                                          },
                                                                          child:
                                                                              Container(
                                                                            width:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                SizedBox(height: 2),
                                                                                Text('Fine Paid', style: TextStyle(fontFamily: 'Sofia', color: Colors.white)),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                        )),
                                                                ...
                                                                child:
                                                                    ClipRRect(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            returnedBook(snapshot.data.docs[index].id);
                                                                          },
                                                                          child:
                                                                              Container(
                                                                            width:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Icon(Icons.done, color: Colors.white),
                                                                                SizedBox(height: 2),
                                                                                Text('Returned', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Sofia', color: Colors.white)),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                        )),
                                                                ...
                                                                child:
                                                                    ClipRRect(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            generateFine(snapshot.data.docs[index]);
                                                                          },
                                                                          child:
                                                                              Container(
                                                                            width:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                SizedBox(height: 2),
                                                                                Text('Generate Fine', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Sofia', color: Colors.white)),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                        )),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                          width:
                                                                              40),
                                                                      Text(
                                                                        snapshot.data.docs[index]['issued_on'].toDate().day.toString() +
                                                                            '-' +
                                                                            snapshot.data.docs[index]['issued_on'].toDate().month.toString() +
                                                                            '-' +
                                                                            snapshot.data.docs[index]['issued_on'].toDate().year.toString(),
                                                                        style: TextStyle(
                                                                            fontFamily:
                                                                                'Sofia',
                                                                            fontSize:
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                          width:
                                                                              40),
                                                                      Text(
                                                                        snapshot.data.docs[index]['return_on'].toDate().day.toString() +
                                                                            '-' +
                                                                            snapshot.data.docs[index]['return_on'].toDate().month.toString() +
                                                                            '-' +
                                                                            snapshot.data.docs[index]['return_on'].toDate().year.toString(),
                                                                        style: TextStyle(
                                                                            fontFamily:
                                                                                'Sofia',
                                                                            fontSize:
